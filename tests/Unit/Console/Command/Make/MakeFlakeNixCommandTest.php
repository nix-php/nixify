...
#[CoversClass(MakeFlakeNixCommand::class)]
final class MakeFlakeNixCommandTest extends AbstractTestCase
{
    public function testExtendsAbstractCommand(): void
    {
        ...
        $style->expects(self::never())
            ->method('title')
            ->seal();
        self::assertInstanceOf(AbstractCommand::class, new MakeFlakeNixCommand($filesystem, $style));
    }
}
