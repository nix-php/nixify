...
#[CoversClass(MakeShellNixCommand::class)]
final class MakeShellNixCommandTest extends AbstractTestCase
{
    public function testExtendsAbstractCommand(): void
    {
        ...
        $style->expects(self::never())
            ->method('title')
            ->seal();
        self::assertInstanceOf(AbstractCommand::class, new MakeShellNixCommand($filesystem, $style));
    }
}
