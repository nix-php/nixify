...
namespace Tests\Unit\Console\Command\Make;
...
#[CoversClass(MakeDefaultNixCommand::class)]
final class MakeDefaultNixCommandTest extends AbstractTestCase
{
    public function testExtendsAbstractCommand(): void
    {
        ...
        $style->expects(self::never())
            ->method('title')
            ->seal();
        self::assertInstanceOf(AbstractCommand::class, new MakeDefaultNixCommand($filesystem, $style));
    }
}
